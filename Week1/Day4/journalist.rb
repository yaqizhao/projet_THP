...
n = 0 
journalistes.each do |firstletter|
if firstletter[1].index(/[A-Z]/)
	n+=1
	end
end
puts n
...
i = 0 
journalistes.each do |letters|
if letters.index(/[A-Z]/)
	i+=1
	end
end
puts i
...
All_journalistes = journalistes.to_a.join
underscore_count = All_journalistes.scan(/_/).length
puts underscore_count

puts "Trie la liste de handle par ordre alphabétique"
puts journalistes[1, 50].sort_by(&:downcase)
